...
```javascript
// unpkg
import init from 'https://unpkg.com/oxiz-wasm@0.1.1/pkg/oxiz_wasm.js';

// jsDelivr
import init from 'https://cdn.jsdelivr.net/npm/oxiz-wasm@0.1.1/pkg/oxiz_wasm.js';
```
...
<script type="module"
    ...
    src="https://unpkg.com/oxiz-wasm@0.1.1/pkg/oxiz_wasm.js">
</script>
```

Generate SRI hash:
```bash
curl https://unpkg.com/oxiz-wasm@0.1.1/pkg/oxiz_wasm.js | \
